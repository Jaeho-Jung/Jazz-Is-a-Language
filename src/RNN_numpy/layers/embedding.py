...
class Embedding:
    ...
    def backward(self, grad_output):
        ...
        # Accumulate gradients using np.add.at for efficient in-place addition
        # This is equivalent to (but more efficient than):
        # for position, idx in enumerate(indices.flat):
        #     self.grad_W[idx] += grad_output.reshape(-1, self.embedding_dim)[position]
