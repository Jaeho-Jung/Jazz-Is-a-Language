"""
Optimizers for NumPy RNN with nested dictionary support.

All optimizers handle both flat and nested parameter dictionaries.
"""

import numpy as np
from src.RNN_numpy.config import LEARNING_RATE, MOMENTUM, RMSPROP_DECAY, ADAM_BETA1, ADAM_BETA2, EPSILON, WEIGHT_DECAY
