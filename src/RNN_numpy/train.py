"""
Training script for NumPy RNN Jazz Solo Generator.

Usage:
    python src/RNN_numpy/train.py
"""
...
from src.RNN_numpy.dataset import JazzDataset
from src.RNN_numpy.model import JazzRNN
from src.RNN_numpy.optimizer import Adam
from src.RNN_numpy.trainer import Trainer
...
def main():
    print("=" * 60)
    print("NumPy RNN Jazz Solo Generator - Training")
    print("=" * 60)
