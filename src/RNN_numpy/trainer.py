"""
Trainer for NumPy RNN Jazz Model.
...
import numpy as np
import time
from src.RNN_numpy.utils import softmax, cross_entropy_loss, cross_entropy_grad
from src.RNN_numpy import config


class Trainer:
    """
    Training orchestrator for JazzRNN model.
