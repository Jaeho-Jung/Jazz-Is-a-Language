...
class Trainer:
    ...
    def train(self, num_epochs=config.NUM_EPOCHS, save_dir='models/lstm'):
        ...
        for epoch in range(num_epochs):
            ...
            torch.save(self.model.state_dict(), os.path.join(save_dir, f'lstm_epoch_{epoch+1}.pth'))
