...
from src.LSTM_pytorch.generator import JazzGenerator
...
def main():
    ...
    parser.add_argument('--checkpoint', type=str, default='models/lstm/lstm_epoch_50.pth', help='Path to model checkpoint')
    ...
    model = JazzLSTM(num_dur_classes=dataset.vocab_size_duration)
    ...
    # 5. Define Chord Progression (Bb Bebop Blues example)
    progression = [
        (5, 2, 48),  # F7
        (10, 2, 48), # Bb7
        (5, 2, 48),  # F7
    ...
    print("\nGenerating solo for F Blues (4 bars)...")
